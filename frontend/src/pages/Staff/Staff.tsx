/**
 * Staff - Staff list & capacity view
 */
...
import type { Staff as StaffType, StaffCreate } from '@/types';
import './Staff.css';
...
export const Staff: React.FC = () => {
  ...
  const getCapacityStatus = (member: StaffType) => {
              ...
              <Link key={member.id} to={`/staff/${member.id}`}>
                <Card variant="elevated" className="staff-card">
                  ...
                  <div className="staff-info">
                    {member.role_title && <p><strong>Role:</strong> {member.role_title}</p>}
                    {member.school && <p><strong>School:</strong> {member.school}</p>}
                    {member.research_group && <p><strong>Research Group:</strong> {member.research_group}</p>}
                  </div>

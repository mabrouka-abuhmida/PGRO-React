...
import {
  createInterviewRecordSlug,
  createReviewRecordSlug,
} from "@/utils/slug";
                  ...
                  >
                    ...
                    {interviewRecords.get(allocation.id)?.id && (
                      <Link
                        ...
                        state={{
                          recordId: interviewRecords.get(allocation.id)!.id,
                        }}
                        style={{
                          color: "#2196F3",
                          textDecoration: "none",
                    ...
                    <Badge
                      variant={
                        review.recommendation === "REJECT"
                          ? "error"
                          : review.recommendation === "INTERVIEW_APPLICANT"
                            ? "warning"
                            : "default"
                      }
                    >
                      {review.recommendation === "INTERVIEW_APPLICANT"
                        ? "Interview Applicant"
                        : review.recommendation === "REVISE_PROPOSAL"
                          ? "Revise Proposal"
                          : review.recommendation === "REJECT"
                            ? "Reject"
                            : review.recommendation}
                ...
                <div className="review-content">
                  {review.recommendation && (
                    <div style={{ marginBottom: "1rem" }}>
                      ...
                      <p
                        style={{ margin: 0, lineHeight: 1.6, fontWeight: 600 }}
                      >
                        {review.recommendation === "INTERVIEW_APPLICANT"
                          ? "Interview Applicant"
                          : review.recommendation === "REVISE_PROPOSAL"
